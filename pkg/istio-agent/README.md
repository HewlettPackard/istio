...
2. In the case where the socket does not exist, istio-agent checks whether certificate files on the fixed path folder (/var/run/secrets/workload-identity) exists. 
